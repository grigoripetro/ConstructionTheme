...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name       = 'et_divi'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		 ...
		 * @var string
		 */
		public $theme_options_file_name = 'divi-settings-backup.txt';
		...
		public function set_demo_menus(){
			...
			set_theme_mod( 'nav_menu_locations', array(
					...
					'secondary-menu' => $main_menu->term_id,
